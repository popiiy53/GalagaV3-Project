...
const std::string ol::Title::CREDIT_TEXT_2 = "(c) 2021 K.H.S.      ";
const std::string ol::Title::CREDIT_TEXT_3 = "(c) 1981 NAMCO LTD.";
...
void ol::Title::draw(Renderer& renderer)
{
    ...
    renderer.drawText1(CREDIT_TEXT_1, ol::Vec2(36.0f, 228.0f), ol::Color::CYAN);

    renderer.drawText1(CREDIT_TEXT_2, ol::Vec2(36.0f, 240.0f), ol::Color::CYAN);

    renderer.drawText1(CREDIT_TEXT_3, ol::Vec2(36.0f, 252.0f), ol::Color::CYAN);
